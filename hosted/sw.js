const CACHE='procureflow-v15';
const CORE=['/','/app.css?v=15','/auth.css?v=15','/mobile.css?v=15','/chat.css?v=15','/hosted.js?v=15','/i18n.js?v=15','/chat.js?v=15','/manifest.webmanifest','/icon.svg','/manual.html'];
