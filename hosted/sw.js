const CACHE='procureflow-v17';
const CORE=['/','/app.css?v=17','/auth.css?v=17','/mobile.css?v=17','/chat.css?v=17','/hosted.js?v=17','/i18n.js?v=17','/chat.js?v=17','/manifest.webmanifest','/icon.svg','/manual.html'];
